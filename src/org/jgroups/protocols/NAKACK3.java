...
public class NAKACK3 extends ReliableMulticast {
    ...
    public int getXmitTableNumCurrentRows() {
        DynamicBuffer<Message> win=getWindow(local_addr);
    ...
    public String dumpXmitTablesNumCurrentRows() {
        ...
        for(Map.Entry<Address,Buffer<Message>> e: xmit_table.entrySet())
            sb.append(String.format("%s: %d\n", e.getKey(), ((DynamicBuffer<Message>)e.getValue()).getNumRows()));
        return sb.toString();
    }
